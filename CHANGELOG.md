...
- Card content not vertically centered after height fix: `ha-card` now uses flexbox (`flex-direction: column; justify-content: center`)

## [1.2.6] - 2026-05-16

### Fixed

- Card height not matching neighboring cards: added `height: 100%` to `:host` and `ha-card` so card fills its grid cell
